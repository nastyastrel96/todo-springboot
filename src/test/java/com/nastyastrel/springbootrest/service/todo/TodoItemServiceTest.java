...
//    @BeforeEach
//    void setUp() {
//        underTest = new TodoItemServiceImpl(todoItemRepository, tagRepository, chuckNorrisClient, userService);
//    }
//
//    @Test
...
//
//        //when
//        var answer = underTest.deleteTodoItem(todoItem.getItemId());
//
//        //then
...
//
//        //when
//        var answer = underTest.todoItemIsDone(todoItem.getItemId());
//
//        //then
//        verify(userService).getAuthenticatedUser();
//        verify(todoItemRepository).findById(eq(todoItem.getItemId()));
